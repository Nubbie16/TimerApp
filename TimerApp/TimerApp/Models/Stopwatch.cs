...
// Description: Defines the Stopwatch class, which will store the necessary properties and methods for a
//              stopwatch timer, such as start time, elapsed time
...
namespace TimerApp.Models
{
    ...
    public string GetLapTime(int hr, int min, int sec, int lap = 0)
        ...
        public string GetEndTime(int hr, int min, int sec, int lap = 0)
        {
